...
export function Footer() {
    ...
    return <footer className={`items-center justify-center flex-col gap-3 px-4 sm:px-6 lg:px-12 xl:px-16 ${location.pathname.slice(0, 7) === "/direct" ? "hidden" : "md:flex hidden"}`}>
