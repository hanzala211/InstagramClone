...
export function Overlay({ handleClose, isPostOpen }) {
    return <>
        <IoCloseSharp
            className={`fixed xl:text-[35px] text-[25px] xl:top-8 lg:top-5 top-12 xl:right-7 lg:right-5 right-2 z-[150] cursor-pointer opacity-0 ${isPostOpen ? "opacity-100" : "pointer-events-none"}`}
            onClick={handleClose}
        />
        <div
