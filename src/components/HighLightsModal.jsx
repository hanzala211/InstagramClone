...
export function HighLightsModal({ setIsCreatingHighLight, isCreatingHighLight }) {
    ...
    return <>
        <div
            ...
            onClick={handleClose}
        ></div>
        <div className={`fixed inset-0 z-50 flex justify-center items-center ${isCreatingHighLight && !selectStatus ? "opacity-100" : "opacity-0 pointer-events-none"} transition-all duration-500`}>
