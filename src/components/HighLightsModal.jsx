...
export function HighLightsModal({ setIsCreatingHighLight, isCreatingHighLight }) {
    ...
    return <>
        <div
            ...
            onClick={() => handleClose()}
        ></div>
        <div className={`w-full max-w-[21vw] bg-[#262626] rounded-xl h-[19vh] fixed inset-0 z-[100] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 transition duration-500 ${isCreatingHighLight && !selectStatus ? "opacity-100" : "pointer-events-none"}`}>
