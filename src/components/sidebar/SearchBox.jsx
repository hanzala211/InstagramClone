...
export function SearchBox({ refere, isSearching }) {
    ...
    return <div
        ref={refere} className={`fixed top-0 h-[100vh] transition-[width] overflow-auto scrollbar-hidden duration-300 ease-in-out ${location.pathname.slice(0, 7) === "/direct" ? "lg:left-20 md:left-20 xl:left-20 bg-[#000]" : "bg-[#000] lg:left-20"} ${isSearching ? "border-r-[1px] border-[#262626] sm:w-[30vw] lg:w-[23rem] opacity-100" : "w-0 opacity-0 pointer-events-none"}`}>
