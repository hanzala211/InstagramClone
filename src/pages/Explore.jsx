...
export function Explore() {
    ...
    return <><section className={`w-full lg:max-w-[80%] xl:max-w-[60%] sm:max-w-[80%] max-w-[95%] mt-10 mx-auto ${isPostsLoading || explorePagePosts.length === 0 ? "h-[85vh]" : ""} ${explorePagePosts.length < 4 ? "xl:h-[95vh]" : ""}`}>
